...
<?require_once( __DIR__.'/head.php' );?>
    ...
    <title><?=$data::$second_service_name;?> - Для сервис-партнёров - Восстановление API ID</title>
            ...
            <div class="page secondary">
                <div class="page-header">
                    <div class="page-header-content">
                        <h1>Для сервис-партнёров<small class="upper">Восстановление API ID</small></h1>
