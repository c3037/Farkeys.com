...
<?require_once( __DIR__.'/head.php' );?>
    ...
    <title><?=$data::$second_service_name;?> - Для пользователей - Регистрация</title>
            ...
            <div class="page secondary">
                <div class="page-header">
                    <div class="page-header-content">
                        <h1>Для пользователей<small class="upper">регистрация</small></h1>
...
<?                                      }
                            ...
                            <form method="post" action="?send">
                                <div class="row">
                                    ...
                                    <div class="span6">
                                        ...
                                        <p class="tertiary-text fg-color-red">
                                            ( доступны только латинские символы и пробелы )
                                        </p>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
<?                                  /*<div class="span6">
                                        <p>Регистрируясь вы принимете условия публичной оферты.</p>
                                    </div>*/
                                    ?>
                                    <div class="span5">
