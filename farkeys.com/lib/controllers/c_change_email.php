...
class Controller
{
    ...
    {
        $main = new Main( '/for-users/change-email' );
    ...
    {
        require_once( MODL.'/m_change_email.php' );
        $model = new Model();
        ...
        elseif( isset( $_POST['query'] ) and !empty( $_POST['query'] ) and $_POST['query'] == 4 )
        {
            $model->sendDataStep4();
        }
    ...
    {
        require_once( VIEW.'/'.SystemData::$folder.'/v_change_email.php' );
    }
}
?>